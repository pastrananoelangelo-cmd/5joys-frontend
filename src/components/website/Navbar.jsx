...
function Navbar() {
  ...
  return (
    <header
      className="sticky top-0 z-40 border-b fj-hairline"
      style={{
    ...
    >
      <Container className="flex items-center justify-between py-4">
        ...
        >
          {NAV_LINKS.map((link) => (
            <button
              key={link.key}
              onClick={() => go(link.key)}
              className="fj-nav-link text-sm"
              data-active={currentPage === link.key}
            >
              {link.label}
            </button>
          ))}
        ...
        <button
          ...
          className="fj-btn-primary hidden lg:inline-flex text-sm"
        >
          Login
        </button>
      ...
      {open && (
        <div
          className="lg:hidden border-t fj-hairline"
        ...
        >
          <Container className="py-4 flex flex-col gap-1">
            ...
            <button
              onClick={() => go("careers")}
              className="fj-btn-primary justify-center mt-3 text-sm"
            >
              View Careers
            </button>
          </Container>
